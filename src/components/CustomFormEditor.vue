  ...
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center">
      ...
      <button
        type="button"
        @click="addQuestion()"
        class="flex items-center text-md font-semibold py-1 px-3 mr-2 rounded-sm text-purple-700 bg-transparent"
      >
        <svg
      ...
      <button
        ...
        class="flex items-center text-sm font-semibold py-1 px-3 rounded-sm border border-transparent text-red-500"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
    ...
    <div v-if="shouldHaveOptions()" class="mt-2">
      <h4 class="text-sm font-semibold mb-1 flex justify-between items-center">
        ...
        <button
          type="button"
          @click="addOption()"
          class="flex items-center text-sm font-semibold py-1 px-2 rounded-sm text-purple-700 bg-transparent"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4"
      ...
      <div
        ...
        :key="option.uuid"
        class="flex items-center mb-1 max-h-[100px] transition-all duration-300 ease-in-out"
      >
