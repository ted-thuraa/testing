            ...
            <div :id="`LinkBox${link.id}`" class="w-full">
                <div id="MainSection" class="relative h-full">
                    <div class="flex items-center justify-between gap-4 p-2">
                        ...
                        >
                            ...
                            <div
                                class="absolute inset-0 flex items-center justify-center bg-transparent group-hover:bg-gray-300/50"
                            >
                                <button
                ...
                >
                    Pick image
                        ...
                        <div
                            class="absolute left-[14rem] -bottom-[1.65rem] flex items-center rounded-[10px] bg-gray-900 p-[0.375rem]"
                            style="
                        ...
                        <div class="flex items-center w-full">
                            ...
                            >
                                <div
                                    ...
                                    "
                                    class="mr-2 truncate cursor-pointer text-gray-950"
                                ...
                                <div
                                    ...
                                    "
                                    class="mr-2 truncate cursor-pointer text-gray-700"
                                    :class="isMobile ? 'text-lg' : 'text-sm'"
                                >
                                    Type url here
                                </div>
