<template>
    <div
        ...
        class="md:block fixed hidden right-0 lg:w-[460px] w-[310px] h-[calc(100%-20px)] mt-[20px] mx-auto border-l border-l-gray-300 pt-10"
    >
        <div
                ...
                <div class="phone">
                    ...
                    <div class="screen-container">
                        <div class="bg">
                            <div
                                class="contenttt"
                                :class="store.state.user.theme.color"
                            >
                    ...
                    /> -->
                                    ...
                                    <div
                                        class="h-full mx-auto w-full overflow-auto z-10"
                                    >
                                        <img
                                        ...
                                        <div
                                            ...
                                            :class="store.state.user.theme.text"
                                        >
                                        ...
                                        <div
                                            v-for="link in store.state.user
                                                .allLinks.data"
                                            class="relative my-4 min-h-[36px] rounded-full flex items-center gap-x-6 overflow-hidden px-1 py-2 transition-all duration-200 hover:-translate-y-1"
                                            :class="
                                                store.state.user.theme.button
                                            "
                                        >
                                            <div
                                                v-if="
                                            ...
                                            <a
                                                :href="link.url"
                                                target="_blank"
                                                class="flex items-center relative w-[calc(100%-10px)] mx-auto rounded-xl"
                                            >
                                                <img
                                                    v-if="link.image"
                                                    class="rounded-full h-[28px] aspect-square"
                                                    :src="link.image"
                                                />
    ...
    background: radial-gradient(85% 125% at 50% 140%, black 66.6%, transparent),
        radial-gradient(
            ...
            hsl(
                    calc(
                        var(--g-h) -
                            var(--g-hue-adjust-2, var(--g-hue-adjust, 0))
                    ),
                    100%,
                    50%
                )
