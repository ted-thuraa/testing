...
<script setup>
import MailingList from "./Forms/MailingList.vue";
import Poll from "./Forms/PollForm.vue";
import Rating from "./Forms/RatingForm.vue";
import Hire from "./Forms/HireForm.vue";
import Contact from "./Forms/ContactForm.vue";
import Custom from "./Forms/CustomForm.vue";
