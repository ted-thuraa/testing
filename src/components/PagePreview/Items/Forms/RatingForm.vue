        ...
        <div class="px-4">
          <div class="mx-auto max-w-2xl">
            <div class="flex max-w-xl flex-col items-center justify-between">
              ...
              <div
                class="text-black relative mt-8 flex items-center justify-between gap-x-4"
              >
                <div
              ...
              <button
                type="submit"
                class="relative block rounded-md px-3.5 py-2.5 text-center text-sm font-semibold focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2"
