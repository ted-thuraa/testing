<template>
  <div
    ...
    class="relative overflow-hidden w-full aspect-[1/1.1] mb-4 rounded-[1.5rem]"
    :class="theme.cardsBg"
  >
      ...
      >
        ...
        >
          <img
            ...
            alt=""
            class="w-full h-[4.5rem] rounded-[1.5rem] object-cover"
          />
        </div>
        <div
        ...
        <p
          class="my-2 px-1 mb-2 w-full text-xs font-medium pr-1 overflow-hidden line-clamp-2"
