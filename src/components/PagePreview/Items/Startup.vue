<template>
  ...
  <div class="relative">
    <div
      class="relative w-full mb-4 p-4 overflow-hidden rounded-[1.5rem] shadow"
      :class="theme.cardsBg"
    >
      <div class="mr-2">
        <div
        ...
        >
          <div
            ...
            class="relative z-10 rounded-full px-3 font-medium text-xs"
            ...
            <div class="flex items-center rounded-lg">
              ...
              >
                <img
                  ...
                  :src="link.faviconurl"
                  alt=""
                  class="h-4 rounded-[0.5rem] object-cover"
                />
              </div>
              <div
                v-else-if="!link.image && !link.faviconurl"
                class="h-4 p-1 rounded-[0.5rem]"
              ></div>

              <p
                class="max-w-[10rem] overflow-hidden flex-1 ml-3 text-base font-bold whitespace-nowrap"
              ...
              <div class="ml-9">
                ...
                >
                  ...
                  <div class="">
                    <span
                      class="text-xs font-medium rounded-[4rem]"
        ...
        <div class="my-2">
          <span
            class="mr-1 inline-flex items-center rounded-xl px-2 text-xs font-medium"
            :class="theme.tagIsland"
            >{{ link.data.type }}</span
          >
          <span
            class="mr-1 inline-flex items-center rounded-xl px-2 text-xs font-medium ing-1"
            :class="theme.tagIsland"
        ...
        <div class="p-2">
          <p
            class="max-h-[5rem] text-xs leading-5 line-clamp-3 font-medium"
            :class="theme.cardsPtext"
          >
            {{ link.description }}
          </p>
