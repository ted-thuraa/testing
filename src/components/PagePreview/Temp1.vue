<template>
  <div class="">
    <div
      v-if="theme"
      class="w-[280px] mx-auto relative flex flex-col overflow-x-hidden h-screen"
    ...
    >
      <div class="relative flex-1 flex overflow-y-hidden overflow-x-hidden">
        ...
        <div class="relative flex-1 overflow-y-auto">
          <div
            class="w-full flex h-screen overflow-y-auto flex-1 flex-col py-12 px-1"
          >
            <section class="">
              <div class="">
                <div class="mb-3">
                  <img
                    class="mx-auto rounded-full w-[4rem] h-[4rem] ring-4 object-cover"
                ...
                <div>
                  <h2
                    class="mt-1 text-center text-xl font-bold leading-9 tracking-tight"
                    :class="theme.htext"
                  >
                ...
                <div class="flex flex-row gap-x-1 justify-center items-center">
                  <h2
                    class="inline-flex gap-2 items-center text-sm"
                    :class="theme.ptext"
                  >
                    <svg
                    ...
                    <span class="text-[0.8rem] font-medium leading-6">{{
                      store.state.user.creator_category
                    }}</span>
                  </h2>
              ...
              <div class="sm:mx-auto sm:max-w-lg">
                <div
                  class="w-full my-6 flex items-center leading-relaxed -space-y-1"
                >
                  <p
                    class="text-[0.8rem] text-center font-medium leading-6 text-sm line-clamp-3"
                    :class="theme.ptext"
                  >
