<template>
  <div class="relative">
    <div></div>
    <div
      class="overflow-hidden card-light-shadow bg-white mb-4 h-auto text-[#1e2330] rounded-[1.5rem]"
    >
      <a
        @click="visitLink"
        class="h-auto w-full appearance-none cursor-pointer"
      >
        <div
        ...
        >
          <div
            class="p-1 shadow-xl rounded-[0.5rem]"
            :class="link.image ? 'bg-gray-100' : ''"
          >
            <img
              loading="lazy"
              :src="link.image"
