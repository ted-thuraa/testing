<template>
  ...
  <div class="relative">
    <div
      class="relative w-full mb-4 p-4 bg-white overflow-hidden card-light-shadow rounded-[1.5rem] shadow sm:p-6"
    >
      <div
        class="relative w-full z-10 flex flex-row flex-nowrap items-center justify-between"
      >
        <div
          class="relative z-10 rounded-full bg-gray-50 px-3 py-[0.275rem] font-medium text-xs text-gray-600 hover:bg-gray-100"
        >
          <span>{{ link.data.status }}</span>
        </div>
        <div>
          <div
            v-if="link.data.showcurrentmrr"
            class="rounded-[1rem] flex items-center px-2 flex-row border border-gray-800 text-[0.6875rem]"
          >
            ...
            <div class="">
              <span class="font-medium rounded-[4rem] text-black"
                >$<!-- -->{{ link.data.currentmrr
                }}<!-- -->/mo</span
              >
            </div>
          </div>
      ...
      <div class="my-2">
        <div>
          <div class="flex items-center rounded-lg">
            ...
            <p
              class="max-w-[10rem] overflow-hidden flex-1 ml-3 text-lg md:text-xl font-bold text-black whitespace-nowrap"
            >
              {{ link.name }}
            </p>
          </div>
      ...
      <div class="my-2">
        <span
          class="mr-1 inline-flex items-center rounded-xl bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10"
          >SaaS</span
        >
        <span
          class="mr-1 inline-flex items-center rounded-xl bg-gray-50 px-2 py-1 text-xs font-medium text-gray-700 ring-1 ring-inset ring-gray-600/10"
      ...
      <!-- <div class="my-2">
                <div class="inline-flex items-center">
                    <div class="mr-2">
                        <h2
                            class="text-xs font-semibold leading-7 text-gray-900"
                        >
                            Type
                        </h2>
                        <p class="mt-0.5 text-xs leading-6 text-gray-600">
                            SaaS
                        </p>
                    </div>
                    <div class="mr-2">
                        ...
                        <p class="mt-0.5 text-xs leading-6 text-gray-600">Ai</p>
                    </div>
                </div>
            </div> -->
      <div class="my-2">
      ...
      <div class="mt-4">
        <div class="w-full">
          <img
            class="rounded-xl shadow-md drop-shadow-md w-full h-auto object-cover"
            :src="link.thumbnailurl"
            alt=""
          />
        </div>
      </div>
      <div class="absolute bottom-[1.1rem] left-0 right-0">
        <div class="px-12">
          <div
            class="p-0.5 flex items-center justify-between bg-black/50 ring-1 ring-inset ring-black/20 rounded-[2rem]"
          >
            <button
              @click="openMoreInfoModal()"
              class="flex flex-row items-center px-2 py-1 text-xs bg-black rounded-[2rem] mr-10"
            >
            ...
            <a
              @click="visitLink"
              class="flex flex-row items-center px-2 py-1 text-xs bg-black rounded-[2rem]"
            >
              <span>Live demo</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
