<template>
    ...
    <div class="flex justify-between items-center">
        ...
        <button class="btn btn-square btn-ghost btn-sm" tabindex="0">
            <svg
    ...
    <div class="flex flex-wrap gap-2">
        <button
            class="btn btn-sm btn-circle !w-[40px] !h-[40px] aspect-square border-0 flex-none"
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
    ...
    <div class="mt-4 p-4">
        <NuxtLink
            ...
            class=""
            >Open your page</NuxtLink
        >
    </div>
    <div
        class="mt-4 p-4 border border-neutral/50 rounded-lg flex items-center gap-4 hover:bg-base-200 duration-200 cursor-pointer"
    >
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        ...
        <div>
            <input
                type="text"
                class="truncate outline-none"
                v-model="cpyLink"
                readonly
            />
            <button
                v-if="isCopied"
                class="font-semibold ml-auto text-green-600"
            >
                Copied
            </button>
            <button v-else @click="copyLink" class="font-semibold ml-auto">
                Copy
            </button>
        </div>
    </div>
...
onMounted(() => {
    ...
    cpyLink.value = `http://pa.ge/${username.value}`;
});
