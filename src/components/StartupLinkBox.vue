    ...
    <div class="w-full card-light-shadow rounded-3xl flex flex-row flex-nowrap">
        ...
        <div class="w-full">
            ...
            <div :id="`LinkBox${link.id}`" class="w-full">
                <div id="MainLinkBoxSection" class="relative px-8 pt-2 pb-5">
                    <div class="flex items-center justify-between py-1 w-full">
                        <div class="relative mb-0.5 w-auto font-medium">
                            <input
                                ...
                                @change="updateLink"
                                id="input-group-1"
                                class="w-[8rem] inputs bg-transparent focus:bg-gray-50 focus:border-opacity-0 focus:border-gray-100 text-gray-900 text-sm rounded-lg focus:ring-blue-50 block pl-4 p-2.5"
                                placeholder="Title"
                            />
                            <div
                    ...
                    <div class="flex items-center justify-between py-1">
                        <div class="relative mb-6 font-medium">
                            <input
                                ...
                                @change="updateLink"
                                id="input-group-1"
                                class="inputs bg-transparent focus:bg-gray-50 focus:border-opacity-0 focus:border-gray-100 text-gray-900 text-sm rounded-lg focus:ring-blue-50 block w-full pl-4 p-2.5"
                                placeholder="url"
                            />
                            <div
                                class="absolute inset-y-0 right-0 flex items-center pr-3.5 pointer-events-none"
                        ...
                        <!-- <div class="flex items-center w-full">
                            <input
                                ...
                                type="text"
                                v-model="url"
                                class="w-full text-sm focus:outline-none text-gray-950 bg-transparent"
                            />
                            <div
                                v-else
                                class="flex items-center w-[calc(100%-2px)] text-gray-950"
                            >
                                <div
                                    @click="
                                        url = link.url;
                    ...
                    <div class="flex items-center justify-between py-1">
                        <div class="flex items-center w-full">
                            <input
                                v-if="editDescription(selectedId, selectedStr)"
                                :id="`editDescriptionInput-${link.id}`"
                                type="text"
                                v-model="description"
                                class="w-full text-sm font-semibold focus:outline-none text-gray-200 bg-transparent"
                            />
                            ...
                            <div v-else class="flex items-center w-full">
                                <div
                                    ...
                                    "
                                    class="font-semibold mr-2 cursor-pointer text-white"
                        ...
                        <div class="flex items-center">
                            <Icon
                                class="cursor-pointer"
                                :class="
                                    isMobile ? 'min-w-[23px]' : 'min-w-[17px]'
                                "
                    ...
                    >
                        ...
                        >
                            <div>
                                <button
                                    @click="editImage()"
                                    class="cursor-pointer pointer-events-auto rounded-[4rem] outline-none mr-2 !p-1.5 bg-gray-950/10"
                                    :class="
                                        isUploadImage
                                            ? ' text-indigo-600'
                                            : ' text-black'
                ...
                >
                    ...
                    >
                        ...
                        />
                        <div
                            class="text-center text-sm font-bold text-gray-950"
                        >
                            Delete
                        </div>
                    </button>
                    ...
                    <div
                        class="flex items-center justify-center pt-3 text-gray-950"
                    >
                        Delete this forever?
                    </div>
                ...
                >
                    <div class="relative w-full bg-[#DFE2D9] py-1.5">
                        ...
                        <div
                            class="text-center text-sm font-bold text-[#45494A]"
                        >
                            Add Thumbnail
                        </div>
                    </div>
                    ...
                    <div
                        class="w-full flex items-center justify-between px-4 py-5"
                    >
                        <img
            ...
            >
                ...
                <div
                    ...
                    :class="[
                        {
                            'max-h-[580px] transition-all duration-300 ease-in mt-10':
                                isEditSaaSData,
                        },
                        {
                            'max-h-0 transition-all duration-200 ease-out':
...
onMounted(() => {
    ...
    document.addEventListener("mouseup", function (e) {
        let editDescriptionInput = document.getElementById(
            `editDescriptionInput-${link.value.id}`
        );
        if (
            editDescriptionInput &&
            !editDescriptionInput.contains(e.target) &&
            selectedStr.value == "isDescription" &&
            link.value.id == selectedId.value
        ) {
            editDescriptionInput.blur();
            emit("updatedInput", { id: 0, str: "" });
        }
    });
});
