        ...
        <div class="w-full">
            ...
            <div :id="`LinkBox${link.id}`" class="w-full">
                <div id="MainLinkBoxSection" class="relative px-8 pt-2 pb-5">
                    <div class="flex items-center justify-between py-1">
                        <div class="flex items-center w-full">
                            <input
                                ...
                                v-model="name"
                                maxlength="18"
                                class="w-full text-sm font-semibold focus:outline-none text-gray-950 bg-transparent"
                            />

                            <div
                                v-else
                                class="flex items-center w-full text-gray-950"
                            >
                                <div
                                    @click="
                                        name = link.name;
                    ...
                    <div
                        class="absolute left-[14rem] bottom-1 flex items-center rounded-[10px] bg-gray-900 p-[0.375rem]"
                        style="
                    ...
                    >
                        <button
                            @click="editImage()"
                            class="cursor-pointer pointer-events-auto rounded-[6px] outline-none !p-1.5"
                            :class="
                                isUploadImage
                                    ? 'bg-white text-black'
                        ...
                        <button
                            ...
                            class="cursor-pointer pointer-events-auto rounded-[4px] outline-none !p-1.5"
                            :class="
                                isUpdateLayout
                                    ? 'bg-white text-black'
                                    : 'bg-transparent text-white'
                ...
                <div
                    ...
                    :class="[
                        {
                            'max-h-[1580px] transition-all duration-300 ease-in':
                                isEditSaaSData,
                        },
                        {
                            'max-h-0 transition-all duration-200 ease-out':
