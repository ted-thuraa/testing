  ...
  <div class="w-full card-light-shadow rounded-3xl flex flex-row flex-nowrap">
    ...
    <div class="w-full">
      ...
      <div :id="`LinkBox${link.id}`" class="w-full">
        <div id="MainSection" class="relative h-full md:px-8 pt-2 pb-14">
            ...
            >
              <div class="flex flex-col items-center justify-center w-full">
                <div class="bgfilterblur p-1 rounded-[2.5rem]">
                  <button
                    @click="(isMoreOption = !isMoreOption), (isDelete = false)"
                    ...
                    "
                    :color="isMoreOption ? '#00000' : '#676B5F'"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
        ...
        >
          ...
          <div class="w-full flex flex-col justify-between px-4 py-5">
            <div class="mb-2">
              <p class="text-gray-700 p-0 m-0 font-semibold text-base">Video</p>
            </div>
            <div class="flex items-center justify-between gap-4 p-2">
              <div class="group relative w-full h-auto bg-gray-500 rounded-2xl">
                <div class="flex h-[340px] w-full overflow-hidden rounded-2xl">
