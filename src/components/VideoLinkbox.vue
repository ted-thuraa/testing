    ...
    <div class="w-full card-light-shadow rounded-3xl flex flex-row flex-nowrap">
        ...
        <div class="w-full">
            ...
            <div :id="`LinkBox${link.id}`" class="w-full">
                <div id="MainSection" class="relative h-full">
                    <div class="flex items-center justify-between p-3">
                        <div class="relative mb-5 w-auto font-medium">
                            <input
                                type="text"
                                v-model="url"
                                @change="updateLink"
                    ...
                    >
                        <div class="flex items-center w-full">
                            <input
                                ...
                                type="text"
                                v-model="url"
                                class="w-full text-sm focus:outline-none text-gray-950"
                                style="
                                    --tw-bg-opacity: 1;
                                    background-color: rgb(
                                        247 247 247 / var(--tw-bg-opacity)
                                    );
                                "
                            />
                        </div>
                ...
                >
                    <div class="relative w-full bg-[#DFE2D9] py-1.5">
                        <button
                            ...
                            class="text-black absolute right-1 top-[6px] cursor-pointer"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                    ...
                    <div class="w-full flex flex-col justify-between px-4 py-5">
                        <div class="mb-2">
                            <p
                                class="text-gray-700 p-0 m-0 font-semibold text-base"
                            >
                                Video
                            </p>
                        </div>
                        ...
                        >
                            <div
                                class="group relative w-full h-auto bg-gray-500 rounded-2xl"
                            >
                                <div
                                    class="flex h-[340px] w-full overflow-hidden rounded-2xl"
                                >
...
import PortfolioData from "./PortfolioData.vue";
...
let isEditPortfolioData = ref(false);
let errors = ref(null);
...
const updatePortfolioThumbnail = async () => {
    try {
        await store.dispatch("updatePortfolioThumbnail", data.value);
        await store.dispatch("getAllLinks");
...
watch(
    () => data.value,
    async () => await updatePortfolioThumbnail()
);
</script>
