<template>
  <div class="block lg:w-[500px] w-[310px] h-[calc(100%-20px)] mx-auto pt-20">
    <div
      class="mx-auto mb-16 flex items-center justify-center w-full lg:max-w-[230px] max-w-[200px] lg:h-[460px] h-[400px] p-3 rounded-3xl relative"
    >
      <div class="body">
        <div class="phone">
          <div class="buttons">
