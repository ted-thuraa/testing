<template>
  ...
  >
    ...
    <aside
      id="sidebar"
      class="relative hidden md:block w-0 md:w-52 flex-none transition-transform -translate-x-full sm:translate-x-0"
      aria-label="Sidebar"
    >
      <div class="px-3 py-4">
        <router-link
        ...
        <div class="px-3">
          ...
          <div class="py-4 border-t-[1px] border-gray-300">
            <div class="inline-flex items-center">
              ...
              <span class="ml-2 text-black font-medium">{{ fullname }}</span>
            </div>
          </div>
        </div>
      </div>
